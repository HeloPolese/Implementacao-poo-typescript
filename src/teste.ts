...
const gerente1 = new Gerente("Ana", "marilandia", "999999999", "33333333333",10, 20000, "regional", new Date('2002-03-20'));
const gerente2 = new Gerente("Heloisa", "Piuma", "9999999999", "11111111111",14, 3000, "regional", new Date('2007-02-20'));
const gerente3 = new Gerente("Fernando", "marilandia", "999999999", "33333333333",15, 20000, "regional", new Date('2002-03-20'));

const atendente1 = new Atendente("janete", "aracruz", "9999999999", "11111111111",70, "PESSOAL", 3000, new Date('2007-02-20'));
const atendente2 = new Atendente("eliane", "Maceió", "9966699999", "11111111199",2,"caixa", 5000, new Date('2000-08-10'));
const atendente3 = new Atendente("Mariana", "Linhares", "995742224", "23244444444",5,"PESSOAL", 15000, new Date('1998-07-21'));
